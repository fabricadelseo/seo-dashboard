...
/* Tabs estilo menú */
.stTabs [data-baseweb="tab-list"]{ gap:34px; border-bottom:1px solid #ececf0; margin:18px 0 6px; }
.stTabs [data-baseweb="tab"]{ height:54px; padding:0 2px; color:#111827; background:transparent; }
